...
def main():
    ...
    if os.path.exists(put1 + '_per.pdf'):
        path = put1 + '_per.pdf'
        os.remove(path)
    if os.path.exists(put1 + 'concat.pdf'):
        path = put1 + 'concat.pdf'
        os.remove(path)
    ...
    if os.path.exists(put1 + 'case_sort.pdf'):
        ...
        os.remove(path)
    if os.path.exists(put3 + '__ved_poc.pdf'):
        path = put3 + '__ved_poc.pdf'
        os.remove(path)
    if os.path.exists(put3 + '__reg_izm.pdf'):
        path = put3 + '__reg_izm.pdf'
        os.remove(path)   
